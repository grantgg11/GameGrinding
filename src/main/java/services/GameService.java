...
public class GameService {
	...
	public GameService(GameDAO gameDAO, CollectionDAO collectionDAO) {
	...
	public boolean updateCompletionStatus(int userID, int gameID, String completionStatus) {
		if(completionStatus == "Not Started" || completionStatus == "Playing" || completionStatus == "Completed") {					
			...
			System.out.println(completionStatus + "Not valid Completion Status.");		
			return false;
		}
	}
    ...
    public List<String> getPlatformsFromCollection(int userID) {
        ...
        List<String> platforms = collectionDAO.getCollectionPlatform(userID, null);

        if (platforms == null) {
            System.out.println("No platforms found in collectionDAO.");
            return Collections.emptyList();
        }
    ...
    public List<String> getGenreFromCollection(int userID) {
        ...
        List<String> genres = collectionDAO.getCollectionGenres(userID, null);

        if (genres == null) {
            System.out.println("Genres returned null.");
            return Collections.emptyList();
        }

        System.out.println("Genres in collection: " + genres);
