...
public class mobyGamesAPIService {
    ...
    protected static final Map<Integer, JsonObject> platformCache = new ConcurrentHashMap<>();// Cache for platform details
    protected static final Map<Integer, JsonObject> gameCache = new ConcurrentHashMap<>();	// Cache for game details
    ...
    static AlertHelper alertHelper = new AlertHelper(); 						// Alert utility
    ...
    protected static String loadApiKey(InputStream input) {
        try {
    ...
    private static String loadApiKey() {
        InputStream input = mobyGamesAPIService.class.getResourceAsStream("/api.properties");
        return loadApiKey(input);
    }
    ...
    public List<game> searchGamesByTitles(String query) throws ParseException, InterruptedException, ExecutionException {
        ...
        try {
            ...
            if(responseTimeMs > 3000) {
				alertHelper.showError("API Response Time Alert", "The API response took longer than expected.", "Please be patient or add the game manually.");
			}
     ...
     * @throws ParseException If there is an error parsing the JSON response.
     */
    protected game fetchGameDetails(int gameID) throws ParseException {
	 ...
	 */
    protected game parseGame(JsonObject gameObject) throws ParseException {
     ...
     * @throws ParseException If there is an error parsing the JSON response.
     */
    protected List<JsonObject> fetchGamePlatforms(int gameID) throws ParseException {
     ...
     * @throws ParseException If there is an error parsing the JSON response.
     */
    protected JsonObject fetchPlatformDetails(int gameID, int platformID) throws ParseException {
