...
public class FilterCollectionController extends BaseController {
	 ...
	 */
    protected void createPlatformButtons() {       
     ...
     */
    protected void createGenreButtons() {       
	 ...
	 */
    protected void createCompletionStatusButtons() {       
    ...
    private void switchToGameCollection(List<game> filteredGames) {
        try {
        	FXMLLoader loader = createGameCollectionLoader();
    ...
    protected FXMLLoader createGameCollectionLoader() {
        return new FXMLLoader(getClass().getResource("/views/GameCollection.fxml"));
    }
