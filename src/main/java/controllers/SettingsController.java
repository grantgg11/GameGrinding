...
public class SettingsController extends BaseController {
    ...
    protected void onUserDataLoad() {
        try {
            ...
            if (currentUser != null) {
                getUsernameField().setText(currentUser.getUsername());
	 ...
	 */
    @FXML
    protected void handleSaveAccount() {
	 ...
	 */
	@FXML
	protected void handleCollectionPageButton() {
		try {
    ...
    protected void handleReportButton() {
        ...
        ReportDAO reportDAO = this.reportDAO != null ? this.reportDAO : new ReportDAO();
        CSVExporter exporter = this.csvExporter != null ? this.csvExporter : new CSVExporter();
        ...
        try {
            ...
            File exportDir = this.exportDir != null ? this.exportDir : new File("exports");
            if (!exportDir.exists()) {
                exportDir.mkdir();
            }
