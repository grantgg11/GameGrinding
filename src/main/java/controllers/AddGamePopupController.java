...
public class AddGamePopupController extends BaseController {
    ...
    @FXML private Button apiButton;   // Button that leads to the API search option
    @FXML private Button manualButton; // Button that leads to the manual add option
     ...
     */
    @FXML
    private void handleManualAddButton() {
